...
static int32_t mndProcessCreateDnodeReq(SRpcMsg *pReq) {
  ...
  auditRecord(pReq, pMnode->clusterId, "createDnode", obj, "", createReq.sql);
...
static int32_t mndProcessDropDnodeReq(SRpcMsg *pReq) {
  ...
  auditRecord(pReq, pMnode->clusterId, "dropDnode", obj1, "", dropReq.sql);
...
static int32_t mndProcessConfigDnodeReq(SRpcMsg *pReq) {
  ...
  auditRecord(pReq, pMnode->clusterId, "alterDnode", obj, "", cfgReq.sql);
