...
static int32_t mndProcessCreateStbReq(SRpcMsg *pReq) {
  ...
  auditRecord(pReq, pMnode->clusterId, "createStb", name.dbname, name.tname, createReq.sql);
...
static int32_t mndProcessAlterStbReq(SRpcMsg *pReq) {
  ...
  auditRecord(pReq, pMnode->clusterId, "alterStb", name.dbname, alterReq.name, alterReq.sql);
...
static int32_t mndProcessDropStbReq(SRpcMsg *pReq) {
  ...
  auditRecord(pReq, pMnode->clusterId, "dropStb", name.dbname, name.tname, dropReq.sql);
