...
static int32_t mndProcessCreateTopicReq(SRpcMsg *pReq) {
  ...
  auditRecord(pReq, pMnode->clusterId, "createTopic", topicName.dbname, dbname.dbname, createTopicReq.sql);
...
static int32_t mndProcessDropTopicReq(SRpcMsg *pReq) {
  ...
  auditRecord(pReq, pMnode->clusterId, "dropTopic", name.dbname, "", dropReq.sql);
