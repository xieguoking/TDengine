...
TAOS_DEFINE_ERROR(TSDB_CODE_INVALID_OPERATION,            "Invalid operation")
TAOS_DEFINE_ERROR(TSDB_CODE_INVALID_VALUE,                "Invalid value")
TAOS_DEFINE_ERROR(TSDB_CODE_INVALID_FQDN,                 "Invalid fqdn")
...
TAOS_DEFINE_ERROR(TSDB_CODE_TSC_DISCONNECTED,             "Disconnected from server")
...
TAOS_DEFINE_ERROR(TSDB_CODE_TSC_INTERNAL_ERROR,           "Tsc internal error")
...
// query
TAOS_DEFINE_ERROR(TSDB_CODE_QRY_INVALID_QHANDLE,          "Invalid query handle")
...
TAOS_DEFINE_ERROR(TSDB_CODE_QRY_JSON_USAGE_ERROR,         "Not supported Json usage")
...
TAOS_DEFINE_ERROR(TSDB_CODE_CTG_INVALID_INPUT,            "catalog invalid input parameters")
...
TAOS_DEFINE_ERROR(TSDB_CODE_SCH_STATUS_ERROR,             "Job status error")
...
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_VALUE_TOO_LONG,            "Value is too long")
...
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_NOT_ALLOWED_FUNC,           "Function(s) only allowed in SELECT list, cannot mixed with non scalar functions or columns")
TAOS_DEFINE_ERROR(TSDB_CODE_PAR_NOT_ALLOWED_WIN_QUERY,      "Window query not supported, since no valid timestamp column included in the result of subquery")
