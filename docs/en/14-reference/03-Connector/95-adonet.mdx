---
title: ADO.NET Connector
sidebar_label: ADO.NET
description: This document describes the TDengine ADO.NET connector.
...
import ADONETInsert from "../../07-develop/03-insert-data/_adonet_sql.mdx"
import ADONETInfluxLine from "../../07-develop/03-insert-data/_adonet_line.mdx"
import ADONETOpenTSDBTelnet from "../../07-develop/03-insert-data/_adonet_opts_telnet.mdx"
import ADONETOpenTSDBJson from "../../07-develop/03-insert-data/_adonet_opts_json.mdx"
import ADONETQuery from "../../07-develop/04-query-data/_adonet.mdx"
import ADONETAsyncQuery from "../../07-develop/04-query-data/_adonet_async.mdx"
