...
#define TSDB_CODE_INVALID_DATA_TYPE             TAOS_DEF_ERROR_CODE(0, 0x011E) // internal
#define TSDB_CODE_VERSION_NOT_COMPATIBLE        TAOS_DEF_ERROR_CODE(0, 0x011F) // internal
...
#define TSDB_CODE_CHECKSUM_ERROR                TAOS_DEF_ERROR_CODE(0, 0x012F) // internal
...
#define TSDB_CODE_INVALID_OPERATION             TAOS_DEF_ERROR_CODE(0, 0x0133)
#define TSDB_CODE_INVALID_VALUE                 TAOS_DEF_ERROR_CODE(0, 0x0134)
#define TSDB_CODE_INVALID_FQDN                  TAOS_DEF_ERROR_CODE(0, 0x0135)
...
#define TSDB_CODE_TSC_STMT_APP_ERROR            TAOS_DEF_ERROR_CODE(0, 0X0232)
...
#define TSDB_CODE_QRY_JSON_USAGE_ERROR          TAOS_DEF_ERROR_CODE(0, 0x072C)
...
#define TSDB_CODE_SCH_NO_NEED_FETCH             TAOS_DEF_ERROR_CODE(0, 0x2506)
#define TSDB_CODE_SCH_API_USAGE_ERROR           TAOS_DEF_ERROR_CODE(0, 0x2507)
...
#define TSDB_CODE_PAR_VALUE_TOO_LONG            TAOS_DEF_ERROR_CODE(0, 0x2610)
